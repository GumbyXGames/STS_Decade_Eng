...
import dcd_eng.Vfx.Kuuga_UnarmedAttack6;
...
public class UnarmedAttack6 extends AbstractCustomCardWithType {
   ...
   public UnarmedAttack6() {
      super("UnarmedAttack6", NAME, "img/cards/UnarmedAttack6.png", 1, DESCRIPTION, CardType.ATTACK, AbstractCardEnum.DCD, CardRarity.UNCOMMON, CardTarget.ENEMY, AbstractCustomCardWithType.CardColorType.Decade);
