...
import dcd_eng.Vfx.Kuuga_UnarmedAttack4;
...
public class UnarmedAttack4 extends AbstractCustomCardWithType {
   ...
   public UnarmedAttack4() {
      super("UnarmedAttack4", NAME, "img/cards/UnarmedAttack4.png", 1, DESCRIPTION, CardType.ATTACK, AbstractCardEnum.DCD, CardRarity.UNCOMMON, CardTarget.ENEMY, AbstractCustomCardWithType.CardColorType.Decade);
