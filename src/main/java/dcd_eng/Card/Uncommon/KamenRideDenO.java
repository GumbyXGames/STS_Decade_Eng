...
public class KamenRideDenO extends AbstractCustomCardWithType {
   public static final String ID = "KamenRideDenO";
   private static final CardStrings cardStrings;
   public static final String NAME;
   public static final String DESCRIPTION;
   public static final String UPGRADE_DESCRIPTION;
   public static final String[] EXTENDED_DESCRIPTION;
   public static final String IMG_PATH = "img/cards/KamenRideDenO.png";
   private static final int COST = 1;
   private List<TooltipInfo> tips;
   private int KRNumber;

   public KamenRideDenO() {
      super("KamenRideDenO", NAME, "img/cards/KamenRideDenO.png", 1, DESCRIPTION, CardType.POWER, AbstractCardEnum.DCD, CardRarity.UNCOMMON, CardTarget.SELF, AbstractCustomCardWithType.CardColorType.DenO);
   ...
   public void use(AbstractPlayer p, AbstractMonster m) {
      ...
      } else if (DCDmod.HenshinTrigger) {
         AbstractDungeon.actionManager.addToBottom(new RemoveKamenRideAction2(p, p));
         Decade Decade = (Decade)AbstractDungeon.player;
         Decade.Trickster(66);
         CardCrawlGame.sound.playA("kamenride", 0.0F);
         CardCrawlGame.sound.playA("deno_henshin", 0.0F);
         if (!DCDmod.BGMTrigger) {
            TurnTimer.StopBGM(false);
            CardCrawlGame.music.playTempBGM("den-o_OP1.ogg");
         }

         AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(p, p, new KamenRideDenOPower(p), 1));
         AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(p, p, new DenOSpecialPower(p)));
         AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(p, p, new StrengthPower(p, 1), 1));
         AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(p, p, new DexterityPower(p, 1), 1));
      } else {
         AbstractDungeon.actionManager.addToTop(new HenshinAndRemoveKamenRideAction(p, p, this.KRNumber, "den-o"));
         AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(p, p, new KamenRideDenOPower(p), 1));
      }
   ...
   static {
      cardStrings = CardCrawlGame.languagePack.getCardStrings("KamenRideDenO");
