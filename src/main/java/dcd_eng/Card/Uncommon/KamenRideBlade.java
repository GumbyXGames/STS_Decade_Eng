...
import dcd_eng.Power.KamenRideBladePower;
...
public class KamenRideBlade extends AbstractCustomCardWithType {
   ...
   public KamenRideBlade() {
      super("KamenRideBlade", NAME, "img/cards/KamenRideBlade.png", 1, DESCRIPTION, CardType.POWER, AbstractCardEnum.DCD, CardRarity.UNCOMMON, CardTarget.SELF, AbstractCustomCardWithType.CardColorType.Blade);
   ...
   public void use(AbstractPlayer p, AbstractMonster m) {
      if (p.hasPower("DecadeViolentEmotionPower")) {
         if (SpecialRideBooker.kamenpower_decadeVE_point < 3) {
            ++SpecialRideBooker.kamenpower_decadeVE_point;
         ...
         if (DCDmod.HenshinTrigger) {
            ...
            CardCrawlGame.sound.playA("blade_henshin", 0.0F);
            ...
            AbstractDungeon.actionManager.addToTop(new HenshinAndRemoveKamenRideAction(p, p, this.KRNumber, "blade"));
         }

         AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(p, p, new KamenRideBladePower(p), 1));
      }
   ...
   public boolean canUse(AbstractPlayer p, AbstractMonster m) {
      ...
      if (!canUse) {
         ...
         if (p.hasPower("DecadeViolentEmotionPower") && SpecialRideBooker.kamenpower_decadeVE_point > 3) {
            canUse = false;
