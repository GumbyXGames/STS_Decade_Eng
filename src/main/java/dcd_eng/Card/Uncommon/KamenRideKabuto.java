...
import dcd_eng.Power.KamenRideKabutoPower;
...
public class KamenRideKabuto extends AbstractCustomCardWithType {
   ...
   public KamenRideKabuto() {
      super("KamenRideKabuto", NAME, "img/cards/KamenRideKabuto.png", 1, DESCRIPTION, CardType.POWER, AbstractCardEnum.DCD, CardRarity.UNCOMMON, CardTarget.SELF, AbstractCustomCardWithType.CardColorType.Kabuto);
   ...
   public void use(AbstractPlayer p, AbstractMonster m) {
      if (p.hasPower("DecadeViolentEmotionPower")) {
         ...
         if (DCDmod.HenshinTrigger) {
            ...
            CardCrawlGame.sound.playA("kabuto_henshin", 0.0F);
            ...
            AbstractDungeon.actionManager.addToTop(new HenshinAndRemoveKamenRideAction(p, p, this.KRNumber, "kabuto"));
         }

         AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(p, p, new KamenRideKabutoPower(p), 1));
