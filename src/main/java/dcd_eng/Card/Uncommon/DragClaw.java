...
public class DragClaw extends AbstractCustomCardWithType {
   ...
   public DragClaw() {
      super("DragClaw", NAME, "img/cards/DragClaw.png", 2, DESCRIPTION, CardType.ATTACK, AbstractCardEnum.DCD, CardRarity.UNCOMMON, CardTarget.ENEMY, AbstractCustomCardWithType.CardColorType.Ryuki);
