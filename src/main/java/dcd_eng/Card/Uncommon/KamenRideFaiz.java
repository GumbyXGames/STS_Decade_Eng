...
import dcd_eng.Power.KamenRideFaizPower;
...
public class KamenRideFaiz extends AbstractCustomCardWithType {
   ...
   public KamenRideFaiz() {
      super("KamenRideFaiz", NAME, "img/cards/KamenRideFaiz.png", 1, DESCRIPTION, CardType.POWER, AbstractCardEnum.DCD, CardRarity.UNCOMMON, CardTarget.SELF, AbstractCustomCardWithType.CardColorType.Faiz);
   ...
   public void use(AbstractPlayer p, AbstractMonster m) {
      if (p.hasPower("DecadeViolentEmotionPower")) {
         AbstractCard c1 = new CrimsonSmash();
         AbstractCard c2 = new PunchingUnit();
         AbstractCard c3 = new SparkleCut();
         AbstractDungeon.actionManager.addToBottom(new MakeTempCardInDrawPileAction(c1, 1, true, true));
         AbstractDungeon.actionManager.addToBottom(new MakeTempCardInDrawPileAction(c2, 1, true, true));
         AbstractDungeon.actionManager.addToBottom(new MakeTempCardInDrawPileAction(c3, 1, true, true));
      } else {
         if (DCDmod.HenshinTrigger) {
            ...
            CardCrawlGame.sound.playA("faiz_henshin", 0.0F);
            ...
            AbstractDungeon.actionManager.addToTop(new HenshinAndRemoveKamenRideAction(p, p, this.KRNumber, "faiz"));
         }

         AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(p, p, new KamenRideFaizPower(p), 1));
      }
