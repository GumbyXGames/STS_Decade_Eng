...
public class Blade_Metal_s extends AbstractCustomCardWithType {
   ...
   public Blade_Metal_s() {
      super("Blade_Metal_s", NAME, "img/cards/BladeMetal.png", 1, DESCRIPTION, CardType.SKILL, AbstractCardEnum.DCD, CardRarity.SPECIAL, CardTarget.SELF, AbstractCustomCardWithType.CardColorType.Blade);
   ...
   public void use(AbstractPlayer p, AbstractMonster m) {
      ...
      if (p.hasPower("Metallicize") && p.getPower("Metallicize").amount >= 35) {
         for(AbstractCard c : p.drawPile.group) {
            if (c.cardID.equals("Blade_Metal") && !this.done) {
