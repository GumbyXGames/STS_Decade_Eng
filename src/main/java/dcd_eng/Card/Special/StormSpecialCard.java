...
public class StormSpecialCard extends AbstractCustomCardWithType {
   ...
   public StormSpecialCard() {
      super("StormSpecialCard", NAME, "img/cards/StormSpecialCard.png", 0, DESCRIPTION, CardType.SKILL, AbstractCardEnum.DCD, CardRarity.SPECIAL, CardTarget.SELF, AbstractCustomCardWithType.CardColorType.Agito);
