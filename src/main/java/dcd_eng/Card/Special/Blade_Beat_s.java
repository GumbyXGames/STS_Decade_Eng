...
public class Blade_Beat_s extends AbstractCustomCardWithType {
   ...
   public Blade_Beat_s() {
      super("Blade_Beat_s", NAME, "img/cards/BladeBeat.png", 1, DESCRIPTION, CardType.SKILL, AbstractCardEnum.DCD, CardRarity.SPECIAL, CardTarget.SELF, AbstractCustomCardWithType.CardColorType.Blade);
   ...
   public void use(AbstractPlayer p, AbstractMonster m) {
      ...
      if (p.hasPower("BladeBeatPower") && p.getPower("BladeBeatPower").amount >= 3) {
         for(AbstractCard c : p.drawPile.group) {
            if (c.cardID.equals("Blade_Beat") && !this.done) {
