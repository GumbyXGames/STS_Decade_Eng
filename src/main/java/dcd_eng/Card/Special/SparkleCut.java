...
import dcd_eng.Vfx.Axel_SparkleCut_Timer;
import dcd_eng.Vfx.Faiz_FAR_SoundsAndAnimation;
import dcd_eng.Vfx.Faiz_SparkleCut;
...
public class SparkleCut extends AbstractCustomCardWithType {
   ...
   public SparkleCut() {
      super("SparkleCut", NAME, "img/cards/FinalAttackRide_Faiz.png", 2, DESCRIPTION, CardType.ATTACK, AbstractCardEnum.DCD, CardRarity.SPECIAL, CardTarget.ENEMY, AbstractCustomCardWithType.CardColorType.Faiz);
   ...
   public void use(AbstractPlayer p, AbstractMonster m) {
      if (SpecialFaizBox.AxelForm) {
         AbstractDungeon.actionManager.addToTop(new VFXAction(new Axel_SparkleCut_Timer(this.damage), 0.0F));
      } else {
         CardCrawlGame.sound.playA("FAR", 0.0F);
         AbstractDungeon.actionManager.addToTop(new VFXAction(new Faiz_SparkleCut(m.drawX, m.drawY, m, this.damage), 0.0F));
