...
public class CrimsonSmash extends AbstractCustomCardWithType {
   ...
   public CrimsonSmash() {
      super("CrimsonSmash", NAME, "img/cards/FinalAttackRide_Faiz.png", 2, DESCRIPTION, CardType.ATTACK, AbstractCardEnum.DCD, CardRarity.SPECIAL, CardTarget.ENEMY, AbstractCustomCardWithType.CardColorType.Faiz);
   ...
   public void use(AbstractPlayer p, AbstractMonster m) {
      if (SpecialFaizBox.AxelForm) {
         AbstractDungeon.actionManager.addToTop(new VFXAction(new Axel_CrimsonSmash_Timer(this.damage), 0.0F));
      } else {
         CardCrawlGame.sound.playA("FAR", 0.0F);
         AbstractDungeon.actionManager.addToTop(new VFXAction(new Faiz_CrimsonSmash(m.drawX, m.drawY, m, this.damage), 0.0F));
