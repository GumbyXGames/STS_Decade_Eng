...
public class Blade_Kick_s extends AbstractCustomCardWithType {
   ...
   public Blade_Kick_s() {
      super("Blade_Kick_s", NAME, "img/cards/BladeKick.png", 1, DESCRIPTION, CardType.SKILL, AbstractCardEnum.DCD, CardRarity.SPECIAL, CardTarget.SELF, AbstractCustomCardWithType.CardColorType.Blade);
