...
public class DragShield_s extends AbstractCustomCardWithType {
   public static final String ID = "DragShield_s";
   ...
   public DragShield_s() {
      super("DragShield_s", NAME, "img/cards/DragShield.png", 1, DESCRIPTION, CardType.SKILL, AbstractCardEnum.DCD, CardRarity.SPECIAL, CardTarget.SELF, AbstractCustomCardWithType.CardColorType.Ryuki);
   ...
   static {
      cardStrings = CardCrawlGame.languagePack.getCardStrings("DragShield_s");
