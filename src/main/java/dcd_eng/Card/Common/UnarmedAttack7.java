...
import dcd_eng.Vfx.Kuuga_UnarmedAttack7;
...
public class UnarmedAttack7 extends AbstractCustomCardWithType {
   ...
   public UnarmedAttack7() {
      super("UnarmedAttack7", NAME, "img/cards/UnarmedAttack7.png", 1, DESCRIPTION, CardType.ATTACK, AbstractCardEnum.DCD, CardRarity.COMMON, CardTarget.ENEMY, AbstractCustomCardWithType.CardColorType.Decade);
   ...
   public void calculateCardDamage(AbstractMonster arg0) {
      ...
      if (arg0 != null && arg0.currentBlock > 0) {
         if (this.upgraded) {
            this.damage *= 2;
         } else {
