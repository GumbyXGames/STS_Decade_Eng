...
import dcd_eng.Power.UnarmedAttack3Power;
import dcd_eng.Vfx.Kuuga_UnarmedAttack3;
import dcd_eng.Vfx.Kuuga_UnarmedAttack3_U;
...
public class UnarmedAttack3 extends AbstractCustomCardWithType {
   ...
   public UnarmedAttack3() {
      super("UnarmedAttack3", NAME, "img/cards/UnarmedAttack3.png", 1, DESCRIPTION, CardType.ATTACK, AbstractCardEnum.DCD, CardRarity.COMMON, CardTarget.ENEMY, AbstractCustomCardWithType.CardColorType.Decade);
