...
public class Faiz_Edge extends AbstractCustomCardWithType {
   ...
   public Faiz_Edge() {
      super("Faiz_Edge", NAME, "img/cards/Faiz_Edge.png", 1, DESCRIPTION, CardType.ATTACK, AbstractCardEnum.DCD, CardRarity.COMMON, CardTarget.ENEMY, AbstractCustomCardWithType.CardColorType.Faiz);
   ...
   public void use(AbstractPlayer p, AbstractMonster m) {
      ...
      if (p.hasPower("KamenRideFaizPower")) {
         ...
         AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(p, p, new Flex1(p, 1), 1));
