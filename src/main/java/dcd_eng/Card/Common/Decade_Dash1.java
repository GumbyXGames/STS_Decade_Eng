...
import dcd_eng.Power.Decade_Dash1Power;
...
public class Decade_Dash1 extends AbstractCustomCardWithType {
   ...
   public Decade_Dash1() {
      super("Decade_Dash1", NAME, "img/cards/Decade_Dash1.png", 1, DESCRIPTION, CardType.SKILL, AbstractCardEnum.DCD, CardRarity.COMMON, CardTarget.ENEMY, AbstractCustomCardWithType.CardColorType.Decade);
