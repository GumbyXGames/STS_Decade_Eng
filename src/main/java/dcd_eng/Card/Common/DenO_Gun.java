...
public class DenO_Gun extends AbstractCustomCardWithType {
   public static final String ID = "DenO_Gun";
   private static final CardStrings cardStrings;
   public static final String NAME;
   public static final String DESCRIPTION;
   public static final String[] EXTENDED_DESCRIPTION;
   public static final String IMG_PATH = "img/cards/DenO_Gun.png";
   private static final int COST = 1;
   private List<TooltipInfo> tips;

   public DenO_Gun() {
      super("DenO_Gun", NAME, "img/cards/DenO_Gun.png", 1, DESCRIPTION, CardType.SKILL, AbstractCardEnum.DCD, CardRarity.COMMON, CardTarget.SELF, AbstractCustomCardWithType.CardColorType.DenO);
   ...
   static {
      cardStrings = CardCrawlGame.languagePack.getCardStrings("DenO_Gun");
