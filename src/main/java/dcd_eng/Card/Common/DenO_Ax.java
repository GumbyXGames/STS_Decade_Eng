...
public class DenO_Ax extends AbstractCustomCardWithType {
   public static final String ID = "DenO_Ax";
   private static final CardStrings cardStrings;
   public static final String NAME;
   public static final String DESCRIPTION;
   public static final String[] EXTENDED_DESCRIPTION;
   public static final String IMG_PATH = "img/cards/DenO_Ax.png";
   private static final int COST = 1;
   private List<TooltipInfo> tips;

   public DenO_Ax() {
      super("DenO_Ax", NAME, "img/cards/DenO_Ax.png", 1, DESCRIPTION, CardType.SKILL, AbstractCardEnum.DCD, CardRarity.COMMON, CardTarget.SELF, AbstractCustomCardWithType.CardColorType.DenO);
   ...
   static {
      cardStrings = CardCrawlGame.languagePack.getCardStrings("DenO_Ax");
