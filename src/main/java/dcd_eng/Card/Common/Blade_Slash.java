...
public class Blade_Slash extends AbstractCustomCardWithType {
   ...
   public Blade_Slash() {
      super("Blade_Slash", NAME, "img/cards/BladeSlash.png", 1, DESCRIPTION, CardType.SKILL, AbstractCardEnum.DCD, CardRarity.COMMON, CardTarget.SELF, AbstractCustomCardWithType.CardColorType.Blade);
