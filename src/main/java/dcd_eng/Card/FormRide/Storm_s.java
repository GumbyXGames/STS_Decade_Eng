...
public class Storm_s extends CustomCard {
   ...
   public Storm_s() {
      super("Storm_s", " ", "img/1024/orb-dark.png", -2, " ", CardType.SKILL, AbstractCardEnum.DCD, CardRarity.BASIC, CardTarget.SELF);
      this.tags.add(DCDmod.RiderCard);
      this.tags.add(DCDmod.SelectCard);
      this.tips = new ArrayList();
      this.tips.add(new TooltipInfo(EXTENDED_DESCRIPTION[0], EXTENDED_DESCRIPTION[1]));
      this.setBackgroundTexture("img/cards/Storm_s.png", "img/cards/Storm_s_p.png");
   }
