...
public class Agito_ReturnPower_Animation extends AbstractGameEffect {
   int stage = 0;
   public static boolean isPlay = false;

   public Agito_ReturnPower_Animation() {
      this.duration = 0.63F;
   ...
   public void update() {
      if (this.duration == this.startingDuration && this.stage == 0 && !isPlay) {
         ...
         String AGITO_POWER_JSON = "img/char/DCD_Animation/agito/agito_form_p_rp.json";
         ...
         VfxController.Rider_power_H.state.setAnimation(0, "rp", false);
         isPlay = true;
         ++this.stage;
      }
