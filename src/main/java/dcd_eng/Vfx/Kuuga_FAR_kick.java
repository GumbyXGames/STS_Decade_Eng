   ...
   public void update() {
      ...
      if (this.duration < this.startingDuration - 1.72F && this.stage == 1) {
         ...
         if (this.source.drawX < this.target.drawX) {
            ...
            AbstractDungeon.effectsQueue.add(new Kuuga_FAR_kick2(this.source, this.target, this.damage, this.start.x, this.start.y, this.Tstart.x, this.Tstart.y));
            this.dispose();
            this.isDone = true;
         }
      }
