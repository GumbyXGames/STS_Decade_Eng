...
public class FREffect extends AbstractGameEffect {
   private float x;
   private float y;
   ...
   public FREffect(String stanceId) {
      ...
      switch (stanceId) {
         case "RED":
            ...
            break;
         case "BLUE":
            this.color = new Color(MathUtils.random(0.0F, 0.1F), MathUtils.random(0.1F, 0.2F), MathUtils.random(0.6F, 0.7F), 0.0F);
            break;
         case "PURPLE":
