...
public class RisingEffect extends AbstractGameEffect {
   private float x;
   private float y;
   private float vY;
   ...
   public RisingEffect() {
      ...
      this.color = CardHelper.getColor(200, 100, 0);
   ...
   public void update() {
      if (this.duration > this.dur_div2) {
         this.color.g = Interpolation.fade.apply(1.0F, 0.0F, (this.duration - this.dur_div2) / this.dur_div2);
         this.color.r = Interpolation.fade.apply(1.0F, 0.0F, (this.duration - this.dur_div2) / this.dur_div2);
      } else {
         this.color.g = Interpolation.fade.apply(0.0F, 1.0F, this.duration / this.dur_div2);
         this.color.r = Interpolation.fade.apply(0.0F, 1.0F, this.duration / this.dur_div2);
      }
